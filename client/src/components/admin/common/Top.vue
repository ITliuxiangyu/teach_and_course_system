<template>
  <div id="top" class="all-item-between">
    <div class="left all-item-between">
      ...
      <el-menu :default-active="activeIndex" ref='topMenu' class="el-menu-demo" style="" background-color="#23262e" text-color="white" active-text-color="green" mode="horizontal" @select="handleSelect">
