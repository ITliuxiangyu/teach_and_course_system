<template>
  <div class="app">
    ...
    <el-dialog title="上传课件" style="text-align:center" :visible.sync="isDialogShow">
      <el-upload drag :action="uploadUrl" multiple :headers="headers" :before-upload="checkFileName" :on-erroe="uploadError" :on-success="uploadSuccess">
...
// http://localhost:8088/api/v1/user/43/course
// http://localhost:8088/api/v1/user/43/course
// http://localhost:8080/app/admin/course/9/base/undefined/course/9/courseware


    this.c_id = this.$route.params.c_id;
    console.log(axios.defaults.baseURL)
    this.uploadUrl = window.Tmp_host + window.actionUrl + `/course/${this.c_id}/courseware`;
