    ...
    <div v-show="action=='overview'">
      ...
      <el-table :data="showData" @sort-change="sortChange">
        ...
        <el-table-column label="操作" fixed="right" width="150px">
          <template slot-scope="scope">
            <el-button type="text" @click="getQustionDetail(scope.row)" size="mini">下载</el-button>
...
export default {
  ...
  methods: {
    ...
    getQustionDetail(item){
      $http.get(`/question_group/${item.qg_id}/all_question?is_download=true`).then(res => {
        console.log("题目信息")
        console.log(res)
      });
    },
