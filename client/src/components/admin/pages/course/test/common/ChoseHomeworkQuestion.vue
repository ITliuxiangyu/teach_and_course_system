      ...
      <el-form-item label="题目数量">
        <el-form label-width="70px">
          ...
          <el-form-item label="简答题">
            <el-input @input="update" class="question-num" v-model="param.question.jianda.num"></el-input> 道，每题
            <el-input @input="update" class="question-num" v-model="param.question.jianda.score"></el-input> 分
          </el-form-item>
        </el-form>
        总分：{{allScore}}
      </el-form-item>
